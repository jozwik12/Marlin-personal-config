...
#define CUSTOM_MACHINE_NAME "Józwikonator Mk5"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.27f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1185f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0708f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0979f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define MPC_TUNING_POS { X_CENTER, Y_CENTER, 0.45f } // (mm) M306 Autotuning position, ideally bed center at first layer height.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  71.6
  #define DEFAULT_bedKi  7.15
  #define DEFAULT_bedKd 478.3
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -24, -16, -1.15 }
